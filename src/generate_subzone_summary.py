...
WALK_FIELDS = [
    ...
    "transit_access_slope", "dest_access_slope", "walkability_slope",
]
...
for sz in subzones:
    props = {
        ...
        "transit_access_slope": sz["transit_access_slope"],
        "dest_access_slope": sz["dest_access_slope"],
        "walkability_slope": sz["walkability_slope"],
    }
