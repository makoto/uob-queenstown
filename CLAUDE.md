...
- **Layer panel** (top-right, max-width 280px): 26 toggleable overlays grouped by 12 collapsible categories (Boundaries, Food & Daily Needs, Transit, Green & Recreation, Active Mobility, Community, Housing, Planning, Street Network, Remote Sensing, Street-Level). Each group header is clickable with a chevron indicator (▶/▼) and smooth CSS max-height animation. Boundaries group is expanded by default; all others are collapsed.
